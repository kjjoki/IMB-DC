      MODULE bundle2
        ...
        !**************************************************************************************
           ...
           SUBROUTINE factor_update_b2(set, factor_old, factor_new) 
               !
               ...
               IMPLICIT NONE
               !**************************** NEEDED FROM USER *************************************
               TYPE(kimppu2), INTENT(INOUT) :: set          ! The bundle
           ...
           END SUBROUTINE factor_update_b2 
        ...
        !**************************************************************************************        
           ...
           FUNCTION give_decrease_b2(set, d) RESULT(decrease)
               !
               ...
               REAL(KIND=dp) :: min_piece  ! The predicted decrease at the moment
               REAL(KIND=dp) :: piece      ! 
               ...
               min_piece = 0.0_dp
               DO j = 1, length
                  min_piece = min_piece - set%current_element%subgrad(j) * d(j)
               END DO
               min_piece = min_piece + set%current_element%lin_error
